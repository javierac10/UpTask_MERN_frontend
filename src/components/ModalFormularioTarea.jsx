...
const ModalFormularioTarea = () => {
    ...
    const { handleModalTarea, modalFormularioTarea, mostrarAlerta, 
                            ...
                            <div className="sm:flex sm:items-start">
                                ...
                                <form className='my-10' onSubmit={handleSubmit}>
                                    ...
                                    <div className='mb-5'>
                                        ...
                                        <textarea  id='descripcion' placeholder='descripcion' value={descripcion} onChange={e=> {setDescripcion(e.target.value)}}
                                        className='border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md' />
                                    </div>
                                    <div className='mb-5'>
                                        <label htmlFor='fechaEntrega'
                                        className='text-gray-700 uppercase font-bold text-sm'>Fecha Entrega Tarea</label>
                                        <input type="date" placeholder='fechaEntrega' id='fechaEntrega'
                                        value={fechaEntrega} onChange={e=> {setFechaEntrega(e.target.value)}}
                                        className='border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md' />
                                    </div>
                                    <div className='mb-5'>
                                        <label htmlFor='prioridad'
                                        className='text-gray-700 uppercase font-bold text-sm'>Prioridad Tarea</label>
                                        <select id="prioridad"
                                        name='prioridad' value={prioridad} onChange={e=> {setPrioridad(e.target.value)}}
                                        className='border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md'>
