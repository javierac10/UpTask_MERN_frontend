...
const ProyectosProvider = ({children}) => {
    ...
    useEffect(() => {
        const obtenerProyectos = async () => {
            try {
                ...
                console.log('ObenerProyecto', token);
                if (!token) return;
    ...
    const editarProyecto = async proyecto => {
        try {
            ...
            .map(proyectoState => proyectoState._id === data._id ? data : proyectoState)
    ...
    const actualizarTareaProyecto = (tarea) => {
        const proyectoActualizado = {...proyecto}
        proyectoActualizado.tareas = proyectoActualizado.tareas
            .map(tareaState => tareaState._id === tarea._id ?
                tarea : tareaState)
        setProyecto(proyectoActualizado)
    }
    ...
    return <ProyectosContext.Provider
        value={{ 
            proyectos,
            mostrarAlerta,
            alerta,
